...
public interface ActProxyAdministrator extends ActProxyAuthenticated {
	 ...
	 */
	public PtBoolean oeAddCoordinator(DtCoordinatorID aDtCoordinatorID, DtLogin aDtLogin,DtPassword aDtPassword, DtBiometricData aDtBiometricData) throws RemoteException, NotBoundException;
