...
public interface ActProxyComCompany extends Remote, JIntIsActor {
	...
	/**
	 * 
	 * @param aEtHumanKind The type of human answering the question
	 ...
	 * @param aDtQuestionID The question id of the answer
	 * @param aDtAnswerID The answer id of the response
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 * @throws NotBoundException Thrown if the server is not bound correctly in RMI settings
	 */
