...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-EM-view-global-01} shows a global view for all actors with their relationships with ctState
...
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-EM-view-global-01}
\end{figure}
\vspace{0.5cm} 
