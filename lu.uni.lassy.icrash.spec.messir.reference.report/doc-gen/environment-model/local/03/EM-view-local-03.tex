...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-EM-view-local-03} shows the local view for the administrator actor and interfaces
...
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-EM-view-local-03}
\end{figure}
\vspace{0.5cm} 
