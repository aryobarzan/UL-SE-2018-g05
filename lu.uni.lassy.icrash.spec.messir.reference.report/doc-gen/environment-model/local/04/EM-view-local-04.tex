...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-EM-view-local-04} shows the local view for the coordinator actor and interfaces
...
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-EM-view-local-04}
\end{figure}
\vspace{0.5cm} 
