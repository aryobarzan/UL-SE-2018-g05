...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-oeSetCrisisHandler}
...
\end{center}
\caption[lu.uni.lassy.icrash.spec.messir.reference Use Case Diagram: uc-oeSetCrisisHandler]{oeSetCrisisHandler subfunction use case
}
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-oeSetCrisisHandler}
\end{figure}
\vspace{0.5cm}
