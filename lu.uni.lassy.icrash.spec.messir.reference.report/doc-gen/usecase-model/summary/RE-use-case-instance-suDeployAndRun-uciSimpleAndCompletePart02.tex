	...
	Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UC-uci-suDeployAndRun-uciSimpleAndComplete-Part02}
	...
	\end{center}
	\caption[lu.uni.lassy.icrash.spec.messir.reference Sequence Diagram: uci-suDeployAndRun-uciSimpleAndComplete-Part02]{uci-suDeployAndRun-uciSimpleAndComplete-Part02 use case instance sequence diagram
	}
	\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UC-uci-suDeployAndRun-uciSimpleAndComplete-Part02}
	\end{figure}
	\vspace{0.5cm}
