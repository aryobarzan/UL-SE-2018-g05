...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-suDeployAndRun}
...
\end{center}
\caption[lu.uni.lassy.icrash.spec.messir.reference Use Case Diagram: uc-suDeployAndRun]{ suDeployAndRun summary use case}
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-suDeployAndRun}
\end{figure}
\vspace{0.5cm}
