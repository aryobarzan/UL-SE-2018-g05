...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-suGlobalCrisisHandling}
...
\end{center}
\caption[lu.uni.lassy.icrash.spec.messir.reference Use Case Diagram: uc-suGlobalCrisisHandling]{ suGlobalCrisisHandling user goal use case}
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-suGlobalCrisisHandling}
\end{figure}
\vspace{0.5cm}
