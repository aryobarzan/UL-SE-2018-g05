...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-ugManageCrisis}
...
\end{center}
\caption[lu.uni.lassy.icrash.spec.messir.reference Use Case Diagram: uc-ugManageCrisis]{ ugManageCrisis user goal use case}
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-ugManageCrisis}
\end{figure}
\vspace{0.5cm}
