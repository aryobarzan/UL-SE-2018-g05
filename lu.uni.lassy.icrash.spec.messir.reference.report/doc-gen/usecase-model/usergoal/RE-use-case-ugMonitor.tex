...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-ugMonitor}
...
\end{center}
\caption[lu.uni.lassy.icrash.spec.messir.reference Use Case Diagram: uc-ugMonitor]{ ugMonitor user goal use case}
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-ugMonitor}
\end{figure}
\vspace{0.5cm}
