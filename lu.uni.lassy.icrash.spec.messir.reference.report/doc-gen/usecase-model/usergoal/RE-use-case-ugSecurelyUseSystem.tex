...
Figure \ref{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-ugSecurelyUseSystem}
...
\end{center}
\caption[lu.uni.lassy.icrash.spec.messir.reference Use Case Diagram: uc-ugSecurelyUseSystem]{ ugSecurelyUseSystem user goal use case}
\label{fig:lu.uni.lassy.icrash.spec.messir.reference-RE-UCD-uc-ugSecurelyUseSystem}
\end{figure}
\vspace{0.5cm}
