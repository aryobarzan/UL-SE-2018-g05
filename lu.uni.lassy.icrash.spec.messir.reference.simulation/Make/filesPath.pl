...
msrFilePath(
     latexProjectFolder,
% CHANGE ONLY THE FOLLOWING LINE (leave the quotes)
'/Volumes/Mac_data/Win_data/data/NG/dvlpt/eclipse/ul.dev/lu.uni.lassy.git.messir.casestudies.icrash.spec/lu.uni.lassy.icrash.spec.messir.reference.simulation/latex'
           ).
